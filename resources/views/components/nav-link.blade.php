...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-indigo-500 text-sm font-medium leading-5 text-slate-100 focus:outline-none focus:border-indigo-600 transition duration-150 ease-in-out'
